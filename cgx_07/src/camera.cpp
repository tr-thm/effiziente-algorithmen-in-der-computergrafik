...
void Camera::update(Vector3 &entityPosition, Quaternion &entityRotation, const double time)
{
    activeCamera = this;

    Matrix entityRotationMatrix = -entityRotation.toMatrix();
    ...
    if (this->type == "fixed")
    {
        ...
        absolutePosition = entityPosition + entityRotation * position;
    }
    else if (this->type == "orbit")
    {
        ...
        absolutePosition = entityPosition + entityRotation * anchor;
    }
